      ...
      <div className="max-w-lg mx-auto">
        ...
        {cart.length === 0 ? (
          ...
          <div className="space-y-3 sm:space-y-4">
            {cart.map((item, index) => (
              <div
                key={item.id}
                className="w-full bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg"
              >
                <div className="p-3 sm:p-4">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <img
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center space-x-2">
                      <button
                        onClick={() => decreaseQuantity(item.id)}
                        className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200"
                      >
                        <FaMinus className="w-2 h-2 sm:w-3 sm:h-3 text-gray-600" />
                      </button>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="w-[90%] max-w-md mx-auto rounded-lg p-4 sm:p-6">
            ...
            <DialogFooter className="space-y-2 sm:space-y-0 sm:flex sm:space-x-2">
              <Button
                variant="outline"
                onClick={() => setIsDialogOpen(false)}
                disabled={isSubmitting}
